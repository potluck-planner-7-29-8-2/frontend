...
// export const
// export const addGuest = (dispatch, guest) => {

// }

// export const removeGuest = (dispatch, guest) => {

// }

// export const changeAttendance = (dispatch, guest_id, isAttending) => {
...
// export const removeRecipe = (dispatch, recipe) => {
