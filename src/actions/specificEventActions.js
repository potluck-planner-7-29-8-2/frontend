...
export const addGuest = (dispatch, id, guest) => {
    ...
    axiosWithAuth()
        ...
        .catch(err => {
            dispatch({type: ADD_GUESTS_ERROR, payload: err.response.data.message})
        })
}
...
export const removeGuest = (dispatch, id, guest) => {
    ...
    axiosWithAuth()
        ...
        .catch(err => {
            dispatch({type: REMOVE_GUEST_ERROR, payload: err.response.data.message})
        })
}
...
export const changeAttendance = (dispatch, id, user_id, isAttending) => {
    ...
    axiosWithAuth()
        ...
        .catch(err => {
            dispatch({type: UPDATE_GUEST_ERROR, payload: err.response.data.message})
        })
}
...
export const removeRecipe = (dispatch, id, recipe) => {
    ...
    axiosWithAuth()
        ...
        .catch(err => {
            dispatch({type: REMOVE_RECIPE_ERROR, payload: err.response.data.message})
        })
}
